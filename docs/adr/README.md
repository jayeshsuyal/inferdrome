...
- [ADR 0013: Authorize a producer-side v0.1 release with deferred ExitSpec evaluation](0013-authorize-producer-side-v0-1-release-with-deferred-exitspec.md)
...
- [ADR 0012: Add opt-in local dashboard authentication](0012-opt-in-local-dashboard-authentication.md)
